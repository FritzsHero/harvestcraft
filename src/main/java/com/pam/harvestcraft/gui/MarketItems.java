...
public class MarketItems
{
      ...
      public static void registerItems()
      {
            ...
            if (BlockRegistry.marketsellPig)
            {
                  ...
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 90), new ItemStack(Items.emerald), BlockRegistry.marketpigPrice));
                  }
                  if (BlockRegistry.marketcurrencyPig == 1)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 90), new ItemStack(Items.diamond), BlockRegistry.marketpigPrice));
                  }
                  if (BlockRegistry.marketcurrencyPig == 2)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 90), new ItemStack(Items.gold_ingot), BlockRegistry.marketpigPrice));
                  }
                  if (BlockRegistry.marketcurrencyPig == 3)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 90), new ItemStack(Items.gold_nugget), BlockRegistry.marketpigPrice));
                  }
                  if (BlockRegistry.marketcurrencyPig == 4)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 90), new ItemStack(Items.iron_ingot), BlockRegistry.marketpigPrice));
                  }
                  if (BlockRegistry.marketcurrencyPig == 5)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 90), new ItemStack(Items.egg), BlockRegistry.marketpigPrice));
                  }
            }
            if (BlockRegistry.marketsellSheep)
            {
                  ...
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 91), new ItemStack(Items.emerald), BlockRegistry.marketsheepPrice));
                  }
                  if (BlockRegistry.marketcurrencySheep == 1)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 91), new ItemStack(Items.diamond), BlockRegistry.marketsheepPrice));
                  }
                  if (BlockRegistry.marketcurrencySheep == 2)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 91), new ItemStack(Items.gold_ingot), BlockRegistry.marketsheepPrice));
                  }
                  if (BlockRegistry.marketcurrencySheep == 3)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 91), new ItemStack(Items.gold_nugget), BlockRegistry.marketsheepPrice));
                  }
                  if (BlockRegistry.marketcurrencySheep == 4)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 91), new ItemStack(Items.iron_ingot), BlockRegistry.marketsheepPrice));
                  }
                  if (BlockRegistry.marketcurrencySheep == 5)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 91), new ItemStack(Items.egg), BlockRegistry.marketsheepPrice));
                  }
            }
            if (BlockRegistry.marketsellCow)
            {
                  ...
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 92), new ItemStack(Items.emerald), BlockRegistry.marketcowPrice));
                  }
                  if (BlockRegistry.marketcurrencyCow == 1)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 92), new ItemStack(Items.diamond), BlockRegistry.marketcowPrice));
                  }
                  if (BlockRegistry.marketcurrencyCow == 2)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 92), new ItemStack(Items.gold_ingot), BlockRegistry.marketcowPrice));
                  }
                  if (BlockRegistry.marketcurrencyCow == 3)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 92), new ItemStack(Items.gold_nugget), BlockRegistry.marketcowPrice));
                  }
                  if (BlockRegistry.marketcurrencyCow == 4)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 92), new ItemStack(Items.iron_ingot), BlockRegistry.marketcowPrice));
                  }
                  if (BlockRegistry.marketcurrencyCow == 5)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 92), new ItemStack(Items.egg), BlockRegistry.marketcowPrice));
                  }
            }
            if (BlockRegistry.marketsellChicken)
            {
                  ...
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 93), new ItemStack(Items.emerald), BlockRegistry.marketchickenPrice));
                  }
                  if (BlockRegistry.marketcurrencyChicken == 1)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 93), new ItemStack(Items.diamond), BlockRegistry.marketchickenPrice));
                  }
                  if (BlockRegistry.marketcurrencyChicken == 2)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 93), new ItemStack(Items.gold_ingot), BlockRegistry.marketchickenPrice));
                  }
                  if (BlockRegistry.marketcurrencyChicken == 3)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 93), new ItemStack(Items.gold_nugget), BlockRegistry.marketchickenPrice));
                  }
                  if (BlockRegistry.marketcurrencyChicken == 4)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 93), new ItemStack(Items.iron_ingot), BlockRegistry.marketchickenPrice));
                  }
                  if (BlockRegistry.marketcurrencyChicken == 5)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 93), new ItemStack(Items.egg), BlockRegistry.marketchickenPrice));
                  }
            }
            if (BlockRegistry.marketsellHorse)
            {
                  ...
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 100), new ItemStack(Items.emerald), BlockRegistry.markethorsePrice));
                  }
                  if (BlockRegistry.marketcurrencyHorse == 1)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 100), new ItemStack(Items.diamond), BlockRegistry.markethorsePrice));
                  }
                  if (BlockRegistry.marketcurrencyHorse == 2)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 100), new ItemStack(Items.gold_ingot), BlockRegistry.markethorsePrice));
                  }
                  if (BlockRegistry.marketcurrencyHorse == 3)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 100), new ItemStack(Items.gold_nugget), BlockRegistry.markethorsePrice));
                  }
                  if (BlockRegistry.marketcurrencyHorse == 4)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 100), new ItemStack(Items.iron_ingot), BlockRegistry.markethorsePrice));
                  }
                  if (BlockRegistry.marketcurrencyHorse == 5)
                  {
                        registerItems(new MarketData(new ItemStack(Items.spawn_egg, 1, 100), new ItemStack(Items.egg), BlockRegistry.markethorsePrice));
                  }
            }
