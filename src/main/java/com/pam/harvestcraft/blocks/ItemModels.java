...
public class ItemModels 
{
	...
	private static void defineItemModels()
	{
		...
		registerItemModels(getItem(BlockRegistry.ArrowrootCrop), new ItemModelList("crops/")
				.add(0, "arrowroot_stage0")
		...
		registerItemModels(getItem(BlockRegistry.ChickpeaCrop), new ItemModelList("crops/")
				.add(0, "chickpea_stage0")
		...
		registerItemModels(getItem(BlockRegistry.GreenGrapeCrop), new ItemModelList("crops/")
				.add(0, "greengrape_stage0")
		...
		registerItemModels(getItem(BlockRegistry.JicamaCrop), new ItemModelList("crops/")
				.add(0, "jicama_stage0")
				.add(1, "jicama_stage1")
				.add(2, "jicama_stage2")
				.add(3, "jicama_stage3"));
