...
public class ItemModels
{
	...
	private static void RegisterCropModels()
	{
		...
		RegisterCropModel(BlockRegistry.SisalCrop, "sisal");
		RegisterCropModel(BlockRegistry.SunflowerCrop, "sunflower");
		RegisterCropModel(BlockRegistry.TaroCrop, "taro");
		RegisterCropModel(BlockRegistry.TomatilloCrop, "tomatillo");
	...
	private static void RegisterFruitModels()
	{
		...
		RegisterFruitModel(BlockRegistry.pamBreadfruit, "breadfruit");
		...
		RegisterFruitModel(BlockRegistry.pamHazelnut, "hazelnut");
		RegisterFruitModel(BlockRegistry.pamJackfruit, "jackfruit");
		RegisterFruitModel(BlockRegistry.pamLemon, "lemon");
		RegisterFruitModel(BlockRegistry.pamLime, "lime");
		RegisterFruitModel(BlockRegistry.pamLychee, "lychee");
		...
		RegisterFruitModel(BlockRegistry.pamPassionfruit, "passionfruit");
		RegisterFruitModel(BlockRegistry.pamPawpaw, "pawpaw");
	...
	private static void RegisterSaplingModels()
	{
		...
		RegisterSaplingModel(BlockRegistry.pambreadfruitSapling, "breadfruit");
		...
		RegisterSaplingModel(BlockRegistry.pamhazelnutSapling, "hazelnut");
		RegisterSaplingModel(BlockRegistry.pamjackfruitSapling, "jackfruit");
		RegisterSaplingModel(BlockRegistry.pamlemonSapling, "lemon");
		RegisterSaplingModel(BlockRegistry.pamlimeSapling, "lime");
		RegisterSaplingModel(BlockRegistry.pamlycheeSapling, "lychee");
		...
		RegisterSaplingModel(BlockRegistry.pampassionfruitSapling, "passionfruit");
		RegisterSaplingModel(BlockRegistry.pampawpawSapling, "pawpaw");
