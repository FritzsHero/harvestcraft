...
public class BlockPamCrop extends Block  implements IGrowable, net.minecraftforge.common.IPlantable
{
    ...
    private static ItemStack GetStack(Block _currentBlock)
    {
        if (_currentBlock == BlockRegistry.AgaveCrop) {
            ...
            return new ItemStack(ItemRegistry.MilletItem);
        } else if (_currentBlock == BlockRegistry.MulberryCrop) {
            return new ItemStack(ItemRegistry.MulberryItem);
        } else if (_currentBlock == BlockRegistry.QuinoaCrop) {
            ...
            return new ItemStack(ItemRegistry.TomatilloItem);
