...
public class BlockRegistry 
{
	...
	public static Block QuinoaCrop;
	public static Block SisalCrop;
	public static Block SunflowerCrop;
	public static Block TaroCrop;
	public static Block TomatilloCrop;
	...
	public static Block pambreadfruitSapling;
	...
	public static Block pamjackfruitSapling;
	...
	public static Block pampassionfruitSapling;
	public static Block pamPawpaw;
	public static Block pampawpawSapling;
	...
	public static void loadBlockRegistry()
	{
		...
		PamTemperateSaplings = new Block[] { pamappleSapling, pamavocadoSapling, pamcherrySapling, pamchestnutSapling, pamhazelnutSapling, pamnutmegSapling, pampawpawSapling, pampearSapling, pamplumSapling, pamsoursopSapling, pamwalnutSapling, pamgooseberrySapling };
		PamWarmSaplings = new Block[] { pamalmondSapling, pamapricotSapling, pambananaSapling, pambreadfruitSapling, pamcashewSapling, pamcoconutSapling, pamdateSapling, pamdragonfruitSapling, pamdurianSapling, pamfigSapling, pamgrapefruitSapling, pamguavaSapling, pamjackfruitSapling, pamlemonSapling, pamlimeSapling, pamlycheeSapling, pammangoSapling, pamoliveSapling, pamorangeSapling, pampapayaSapling, pampassionfruitSapling, pampeachSapling, pampecanSapling, pampeppercornSapling, pampersimmonSapling, pampistachioSapling, pampomegranateSapling, pamrambutanSapling, pamstarfruitSapling, pamtamarindSapling, pamvanillabeanSapling };
	...
	private static void RegisterCrops()
	{
		...
		QuinoaCrop = RegisterPamCrop("QuinoaCrop");
		SisalCrop = RegisterPamCrop("SisalCrop");
		SunflowerCrop = RegisterPamCrop("SunflowerCrop");
		TaroCrop = RegisterPamCrop("TaroCrop");
		TomatilloCrop = RegisterPamCrop("TomatilloCrop");
	...
	private static void RegisterTrees()
	{
		...
		pamBreadfruit = RegisterPamFruit("pamBreadfruit");
		pambreadfruitSapling = new BlockPamSapling("breadfruit_sapling");
		...
		pamJackfruit = RegisterPamFruit("pamJackfruit");
		pamjackfruitSapling = new BlockPamSapling("jackfruit_sapling");
		...
		pamPassionfruit = RegisterPamFruit("pamPassionfruit");
		pampassionfruitSapling = new BlockPamSapling("passionfruit_sapling");
		pamPawpaw = RegisterPamFruit("pamPawpaw");
		pampawpawSapling = new BlockPamSapling("pawpaw_sapling");
		...
		pamRambutan = RegisterPamFruit("pamRambutan");
		pamrambutanSapling = new BlockPamSapling("rambutan_sapling");
		pamSoursop = RegisterPamFruit("pamSoursop");
		pamsoursopSapling = new BlockPamSapling("soursop_sapling");
		pamStarfruit = RegisterPamFruit("pamStarfruit");
		pamstarfruitSapling = new BlockPamSapling("starfruit_sapling");
		pamTamarind = RegisterPamFruit("pamTamarind");
		pamtamarindSapling = new BlockPamSapling("tamarind_sapling");
