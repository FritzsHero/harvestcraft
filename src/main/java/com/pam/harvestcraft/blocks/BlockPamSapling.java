...
public class BlockPamSapling extends BlockBush implements IGrowable
{
	...
	private void SetWoodAndFruit()
	{
		...
		else if (this == BlockRegistry.pambreadfruitSapling)
		{
			fruitType = BlockRegistry.pamBreadfruit;
		}
		...
		else if (this == BlockRegistry.pamguavaSapling)
		{
			fruitType = BlockRegistry.pamGuava;
		}
		else if (this == BlockRegistry.pamhazelnutSapling)
		{
			fruitType = BlockRegistry.pamHazelnut;
		}
		else if (this == BlockRegistry.pamjackfruitSapling)
		{
			fruitType = BlockRegistry.pamJackfruit;
		}
		...
		else if (this == BlockRegistry.pampassionfruitSapling)
		{
			fruitType = BlockRegistry.pamPassionfruit;
		}
		else if (this == BlockRegistry.pampawpawSapling)
		{
			fruitType = BlockRegistry.pamPawpaw;
		}
		...
		else if (this == BlockRegistry.pamrambutanSapling)
		{
			fruitType = BlockRegistry.pamRambutan;
		}
		else if (this == BlockRegistry.pamsoursopSapling)
		{
			fruitType = BlockRegistry.pamSoursop;
		}
		else if (this == BlockRegistry.pamstarfruitSapling)
		{
			fruitType = BlockRegistry.pamStarfruit;
		}
		else if (this == BlockRegistry.pamtamarindSapling)
		{
			fruitType = BlockRegistry.pamTamarind;
		}
