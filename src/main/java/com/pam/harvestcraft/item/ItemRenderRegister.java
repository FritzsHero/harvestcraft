...
public final class ItemRenderRegister
{
	public static void registerItemRenderer()
	{
		...
		reg(ItemRegistry.PressedWaxItem);
		...
		reg(ItemRegistry.breadfruitItem);
		...
		reg(ItemRegistry.jackfruitItem);
		reg(ItemRegistry.lemonItem);
		reg(ItemRegistry.limeItem);
		reg(ItemRegistry.lycheeItem);
		...
		reg(ItemRegistry.passionfruitItem);
		reg(ItemRegistry.pawpawItem);
