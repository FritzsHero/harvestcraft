...
public class ItemRegistry
{
	...
	private static Item RegisterCrop(Block _crop, Block _ground, String _name)
	{
        ...
        private static void RegisterFruits()
        {
                ...
                breadfruitItem = RegisterFruit("BreadfruitItem");
                ...
                lycheeItem = RegisterFruit("LycheeItem");
                ...
                passionfruitItem = RegisterFruit("PassionfruitItem");
                pawpawItem = RegisterFruit("PawpawItem");
        ...
        private static void RegisterItemFoods()
        {
                ...
                GameRegistry.registerItem(BakedCactusItem = new ItemFood(2, snacksaturation, false).setUnlocalizedName("BakedCactusItem").setCreativeTab(harvestcraft.modTab), "BakedCactusItem");
