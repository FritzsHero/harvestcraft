...
public class Recipes
{
     ...
     private static void AddYogurts()
     {
     ...
     private static void AddSmoothies()
     {
     ...
     private static void AddJellySandwiches()
     {
     ...
     {
          // In 1.8 the same as FurnaceRecipes.instance().addSmelting
     ...
     private static void RegisterGeneralSmelting()
     {
          ...
          // In 1.8 the same as FurnaceRecipes.instance().addSmeltingRecipeForBlock
