...
public class PamFoodRecipes
{
     ...
     public static void getRecipes()
     {
          ...
          recipeList.add(new ShapelessOreRecipe(ItemRegistry.tunasaladItem, new Object[] { "toolCuttingboard", ItemRegistry.tunarawItem, "foodPickles", "foodMayo", "cropCelery", "foodBlackpepper" }));
          recipeList.add(new ShapelessOreRecipe(ItemRegistry.TurkishDelightItem, new Object[] { "toolPot", "listAllwater", "listAllsugar", "cropOrange", ItemRegistry.vanillabeanItem, "cropPistachio" }));
          recipeList.add(new ShapelessOreRecipe(ItemRegistry.VanillaConchasBreadItem, new Object[] { "toolBakeware", "foodDough", "listAllsugar", "listAllegg", "foodVanilla" }));
          recipeList.add(new ShapelessOreRecipe(ItemRegistry.VanillaCupcakeItem, new Object[] { "toolBakeware", "foodBatter", "listAllsugar", "listAllheavycream", "foodButter", "foodVanilla" }));
          recipeList.add(new ShapelessOreRecipe(ItemRegistry.wontonsoupItem, new Object[] { "toolPot", "foodStock", "foodDough", "cropScallion", "cropGinger", "foodSoysauce" }));
