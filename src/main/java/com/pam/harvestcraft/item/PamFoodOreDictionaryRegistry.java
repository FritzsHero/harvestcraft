...
public class PamFoodOreDictionaryRegistry
{
	public static void getRegistry()
	{
		...
		OreDictionary.registerOre("cropBreadfruit", ItemRegistry.breadfruitItem);
		OreDictionary.registerOre("listAllfruit", ItemRegistry.breadfruitItem);
		...
		OreDictionary.registerOre("cropGuava", ItemRegistry.guavaItem);
		OreDictionary.registerOre("listAllfruit", ItemRegistry.guavaItem);
		OreDictionary.registerOre("cropHazelnut", ItemRegistry.hazelnutItem);
		OreDictionary.registerOre("cropJackfruit", ItemRegistry.jackfruitItem);
		OreDictionary.registerOre("listAllfruit", ItemRegistry.jackfruitItem);
		OreDictionary.registerOre("cropLychee", ItemRegistry.lycheeItem);
		...
		OreDictionary.registerOre("cropRambutan", ItemRegistry.rambutanItem);
		OreDictionary.registerOre("listAllfruit", ItemRegistry.rambutanItem);
		OreDictionary.registerOre("cropSoursop", ItemRegistry.soursopItem);
		OreDictionary.registerOre("listAllfruit", ItemRegistry.soursopItem);
		OreDictionary.registerOre("cropTamarind", ItemRegistry.tamarindItem);
	...
	public static void GetAdditionalRegistry()
	{
		...
		OreDictionary.registerOre("materialWax", ItemRegistry.PressedWaxItem);
