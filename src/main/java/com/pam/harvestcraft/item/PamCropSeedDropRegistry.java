...
public class PamCropSeedDropRegistry
{
    public static void getSeedDrops()
    {
        ...
        if (ItemRegistry.curryleafseeddropfromgrass)
        {
            MinecraftForge.addGrassSeed(new ItemStack(ItemRegistry.curryleafseedItem, 1, 0), ItemRegistry.seedrarity);
        }
        if (ItemRegistry.sesameseedsseeddropfromgrass)
        {
            MinecraftForge.addGrassSeed(new ItemStack(ItemRegistry.sesameseedsseedItem, 1, 0), ItemRegistry.seedrarity);
        }
        if (ItemRegistry.waterchestnutseeddropfromgrass)
        {
            MinecraftForge.addGrassSeed(new ItemStack(ItemRegistry.waterchestnutseedItem, 1, 0), ItemRegistry.seedrarity);
        }
    }
}
