...
public class FruitTreeWorldGen implements IWorldGenerator
{
	...
	private Block GetTemperateFruit(Random _random)
	{
		switch (_random.nextInt(11))
		{
			...
			case 11:
				return BlockRegistry.pamSoursop;
			default:
				return BlockRegistry.pamApple;
		}
	}
	...
	private Block GetTropicalFruit(Random _random)
	{
		...
		switch (_random.nextInt(31))
		{
			...
			case 28:
				return BlockRegistry.pamLychee;
			case 29:
				return BlockRegistry.pamPassionfruit;
			case 30:
				return BlockRegistry.pamRambutan;
			case 31:
				return BlockRegistry.pamTamarind;
			default:
				return BlockRegistry.pamApple;
		}
	}
